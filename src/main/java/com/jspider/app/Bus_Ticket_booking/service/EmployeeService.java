...
public class EmployeeService
{
	...
	public ResponseEntity<ResponseStructure<EmployeeDto>> saveEmployee(EmployeeEntity emp)
	{
		ResponseStructure<EmployeeDto> structure = new ResponseStructure<>();
		
		EmployeeEntity saveemp = eDao.saveEmployee(emp);
	...
	public ResponseEntity<ResponseStructure<EmployeeDto>> findEmployee(int id)
	{
		...
		EmployeeEntity findEmployee = eDao.findById(id);
	...
	public ResponseEntity<ResponseStructure<EmployeeDto>> updateEmployee(EmployeeEntity emp, int id)
	{
        ResponseStructure<EmployeeDto> structure = new ResponseStructure<>();
		
		EmployeeEntity ex_emp = eDao.updateEmployee(emp, id);
	...
	public ResponseEntity<ResponseStructure<EmployeeDto>> deleteEmployee(int id)
	{
		...
		EmployeeEntity emp = eDao.deleteEmployee(id);
	...
	public ResponseEntity<ResponseStructure<List<EmployeeDto>>> getAllEmployees()
	{
		...
		List<EmployeeEntity> allempsentity = eDao.getAllEmployees();
		
		List<EmployeeDto> allemps = new ArrayList<>();
		
		if(allempsentity != null)
		{
			for(EmployeeEntity e : allempsentity)
			{
